...
export const MONSTERS: MonsterDef[] = [
  {
    ...
    tamed: "Tamed. People Pleasing isn't gone — but it's yours now, and your voice gets through.",
  },
  {
    id: 'overthinking',
    dimension: 'awareness',
  ...
  },
  {
    ...
    tamed: "Tamed. Losing Direction isn't gone — but it's yours now, and you can see a step ahead.",
  },
  {
    id: 'the_spiral',
    ...
    tamed: "Tamed. Anxiety isn't gone — but it's yours now, and you hold your ground.",
  },
  {
    id: 'the_hollow',
    ...
    tamed: "Tamed. Self Doubt isn't gone — but it's yours now, and you stand on your own.",
  },
  {
    id: 'the_comparer',
    dimension: 'gratitude',
    ...
    tamed: "Tamed. Comparison isn't gone — but it's yours now, and you look to your own path.",
  },
  {
    id: 'the_wall',
    ...
    tamed: "Tamed. Isolation isn't gone — but it's yours now, and you let people in.",
  },
];

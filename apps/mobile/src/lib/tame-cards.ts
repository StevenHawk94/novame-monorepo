...
const RAW: Record<string, Entry[]> = {
  ...
  the_comparer: [
    ...
    { a: `Comparison naturally pulls your attention upward, toward people who seem to have more, rarely downward toward the much larger number of people who have less. That built-in bias quietly guarantees you'll feel behind almost constantly, no matter how much you've already accomplished in your life.`,
      p: `I never noticed I only ever compare up, never down. No wonder I always feel behind—the math was rigged against me from the start.` },
    ...
    { a: `Comparing yourself to others isn't a character flaw—it's an old survival instinct that once helped you figure out where you stood in a group to stay safe and fed. The problem was never the instinct itself; it's treating its output as a verdict on your actual worth as a person.`,
      p: `I've been treating this like a personal failing, when it's just old wiring doing its job. Maybe I don't have to believe everything it tells me.` },
    { a: `You rarely compare yourself to everyone fairly—you compare yourself mainly to whoever happens to be visible right now, in your feed or your immediate circle, which is closer to a random sample than any meaningful measure of where you actually stand in life.`,
      p: `I'm basically measuring myself against whoever showed up in my feed today. That's really not a fair scale to judge my whole life against.` },
  ...
  the_hollow: [
    ...
    { a: `Not all doubt is the same kind of signal. Doubt that quietly questions your entire worth as a person is corrosive and rarely useful, but doubt that simply questions your current approach can actually make you sharper. Learning to tell these two apart matters more than trying to silence doubt.`,
      p: `I've been treating every doubt the same way, like it's an attack on me. Maybe some of it is just useful information about my approach, not my worth.` },
    ...
    { a: `Most people assume others are scrutinizing their every move and mistake, when in reality, everyone is far more focused on managing their own doubts to notice yours nearly as closely as you fear. The spotlight you feel on your every flaw is mostly just in your own head, not out there watching you.`,
      p: `I keep assuming everyone's watching and judging me closely. They're probably too caught up in their own doubts to notice mine that much.` },

...
export const GOOD_VIBE_ART: readonly ImageSourcePropType[] = [
  // These compatibility copies intentionally use simple PNG filenames. The
  // supplied transparent WebPs contain embedded ICC profiles that some iOS
  // expo-image/SDWebImage builds fail to decode without reporting an error.
  require('../../assets/Good Vibes/love-you-to-bits.png'),
  require('../../assets/Good Vibes/so-grateful-for-you.png'),
  require('../../assets/Good Vibes/always-by-your-side.png'),
  require('../../assets/Good Vibes/you-mean-the-world.png'),
  require('../../assets/Good Vibes/rooting-for-you-always.png'),
  require('../../assets/Good Vibes/good-things-are-coming.png'),
  require('../../assets/Good Vibes/youve-got-this.png'),
  require('../../assets/Good Vibes/keep-shinning-your-light.png'),
  require('../../assets/Good Vibes/ride-or-die-no-cap.png'),
  require('../../assets/Good Vibes/proud-of-you-always.png'),
  require('../../assets/Good Vibes/sending-a-big-hug.png'),
  require('../../assets/Good Vibes/thinking-of-you-today.png'),
  require('../../assets/Good Vibes/tomorrows-a-fresh-start.png'),
  require('../../assets/Good Vibes/delulu-is-the-solulu.png'),
  require('../../assets/Good Vibes/dont-let-idiots-ruin-your-day.png'),
  require('../../assets/Good Vibes/main-character-energy-only.png'),
  require('../../assets/Good Vibes/more-expresso-less-depresso.png'),
  require('../../assets/Good Vibes/in-my-rest-healing-era.png'),
  require('../../assets/Good Vibes/slay-the-day-then-take-a-nap.png'),
  require('../../assets/Good Vibes/kindness-is-cool-drama-is-not.png'),
  require('../../assets/Good Vibes/overthining-but-make-it-cute.png'),
  require('../../assets/Good Vibes/everyday-counts-truly.png'),
  require('../../assets/Good Vibes/big-wins-ahead-today.png'),
  require('../../assets/Good Vibes/forever-on-your-team.png'),
  require('../../assets/Good Vibes/my-favorite-notification-is-you.png'),
];
